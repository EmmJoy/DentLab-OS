                    ...
                    <form action="{{ route('admin.patients.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('doctor_email') is-invalid @enderror" id="doctor_email" name="doctor_email" value="{{ old('doctor_email') }}" placeholder="doctor@example.com">
                                @error('doctor_email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
